...
<html>
  ...
  <body class="">
    <span class="preheader">This is preheader text. You may see this as a preview.</span>
                ...
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p>Good morning,</p>
                        <p>Catch recent scores and links to NHL video recaps below!</p>
                        ...
                        <p>This is the incomplete email without last night's results.</p>
